...
void Character::SetWeapon(unique_ptr<Weapon> weapon) {
	this->currentWeapon = move(weapon);
}

void Character::SetDamageModifier(shared_ptr<DamageModifier> modifier) {
